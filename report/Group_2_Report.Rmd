...
As we see price differences between adjacant seasons, we found strong correlation between these residuals and they tend to become unstable as the price went larger. So we decided to calculate the log of the rate of the price change and observe its residual. 
```{r}
